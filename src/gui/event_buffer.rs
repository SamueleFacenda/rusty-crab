...
impl GuiEventBuffer {
    ...
    pub fn sunray_sent(&mut self, planet_id: ID) {
        self.buffer.push(OrchestratorEvent::SunraySent { planet_id });
    }
    ...
    pub fn asteroid_sent(&mut self, planet_id: ID) {
        self.buffer.push(OrchestratorEvent::AsteroidSent { planet_id });
    }
